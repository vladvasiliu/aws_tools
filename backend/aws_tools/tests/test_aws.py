...
from backend.aws_tools.models import AWSAccount, Instance
...
class SingleRegionInstanceTest(TestCase):
    def setUp(self):
        ...
        self.aws_account = AWSAccount.objects.create(
            _name="Test Account", id="123459823571", role_arn="arn:aws:iam::123459823571:role/aws-tools"
        )
    ...
    def test_all_created_ids_are_imported(self):
        ...
        self.assertListEqual(
            created_instance_ids, imported_instance_ids, "created instance ids don't match imported ids"
        )
    ...
    def test_names_are_imported(self):
        ...
        self.assertEquals(instance_name, imported_instance.name, "created instance name doesn't match imported name")
    ...
    def test_names_are_deleted_on_update(self):
        ...
        imported_instance = Instance.objects.first()
        self.assertEquals(
            created_instance.id, imported_instance.name, "created instance name doesn't match imported name"
        )
    ...
    def test_imported_instances_are_present(self):
        ...
        Instance.update(self.aws_account)
        imported_instance = Instance.objects.first()
        self.assertTrue(imported_instance.present, "imported instance not marked present")
